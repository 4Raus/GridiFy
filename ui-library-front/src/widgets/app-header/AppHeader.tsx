        ...
        <header className={compact ? 'app-header app-header--compact' : 'app-header'}>
            <div className="app-header__brand-group">
                <Link to="/" className="brand-link">
                    <span className="brand-link__title">{appMeta.name}</span>
                    <span className="brand-link__badge">{appMeta.version}</span>
                </Link>
            </div>

            <nav className="app-header__nav">
                <a href={externalLinks.figma} target="_blank" rel="noreferrer">
                    {t({ ru: 'Ресурсы', en: 'Resources', de: 'Ressourcen' }, locale)}
                </a>
                <NavLink to="/library">
                    {t({ ru: 'Компоненты', en: 'Components', de: 'Komponenten' }, locale)}
                </NavLink>
            </nav>
            ...
            <div className="app-header__actions">
                ...
                <a className="icon-button" href={externalLinks.github} target="_blank" rel="noreferrer" aria-label="GitHub">
                    <GithubIcon />
                </a>
            </div>
        </header>
